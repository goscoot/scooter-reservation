...
export const scooters: Scooter[] = [
  {
    ...
    range: 50,
    price: 29,
    thumbnail: "../assets/ducatipro3.webp",
    description:
  ...
  },
  {
    ...
    range: 40,
    price: 24,
    thumbnail: "../assets/pureadvance.webp",
    description:
  ...
  },
  {
    ...
    range: 45,
    price: 29,
    thumbnail: "../assets/flowxtspro.webp",
    description:
  ...
  },
  {
    ...
    range: 45,
    price: 29,
    thumbnail: "../assets/apriliaesr2.webp",
    description:
      "With an incredible 45km max range from a single charge, the St Kilda XTS Pro is the ultimate cruiser built with the demands of everyday life in mind. Constructed from aviation-grade aluminium alloy and engineered to the highest standards, the St Kilda XTS Pro looks stunning and boasts performance to match.",
    color: "black",
  },
  {
    ...
    range: 40,
    price: 24,
    thumbnail: "../assets/ducatipro2.webp",
    description:
  ...
  },
  {
    ...
    range: 65,
    price: 39,
    thumbnail: "../assets/segwayg30d.webp",
    description:
  ...
  },
  {
    ...
    range: 65,
    price: 39,
    thumbnail: "../assets/segwaye45d.webp",
    description:
